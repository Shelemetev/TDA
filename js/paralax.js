...
window.addEventListener("scroll", (e) => {
    ...
    if (y < 621 && y > 100) {
        document.querySelector('.about__back--1').style.transform = `translate(-50%,-${(y / 2) - 100}px)`
        document.querySelector('.about__back--2').style.transform = `translate(-50%,${(y / 2) - 90}px)`
    }
})
